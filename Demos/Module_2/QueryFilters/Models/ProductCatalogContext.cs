...
public partial class ProductCatalogContext : DbContext
{
    ...
    { 
       optionsBuilder.UseSqlServer("Server = .\\sqlexpress; Database=ProductCatalog;Trusted_Connection=True;TrustServerCertificate =True;MultipleActiveResultSets=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            ...
            // TODO
            entity.HasQueryFilter(b => b.Name.StartsWith("M"));
        });
